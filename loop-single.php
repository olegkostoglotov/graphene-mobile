	...
	<?php if ( mgraphene_should_show_parent() ) : ?>
        <div <?php post_class( array( 'entry' ) ); ?>>
            ...
            <div class="entry-header">
                ...
                <?php /* The post meta */
                if ( ! $mgraphene_settings['hide_post_meta'] ) { ?>
            ...
            <?php /* The categories */ ?>
            <?php if ( ! $mgraphene_settings['hide_post_cat'] ) : ?>
			...
			if ( ! $mgraphene_settings['hide_post_image'] ) :
            ...
            <?php /* The tags */ ?>
            <?php if ( ! $mgraphene_settings['hide_post_tags'] && get_the_tags() ) : ?>
            <div class="top-shadow">&nbsp;</div>
            ...
            <?php /* The post navigation */ mgraphene_post_nav(); ?>
